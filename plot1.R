plot1 <- function(iData = "household_power_consumption.txt", iDate = c("1/2/2007","2/2/2007")){
        ...
        hist(dHouPwrCon$Global_active_power, col= "red", main = "Global Active Power", xlab = "Global Active Power (kilowatts)")
        dev.off()
